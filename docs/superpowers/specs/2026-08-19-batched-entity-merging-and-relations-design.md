...
Replace the single complete-graph Entity Relation Generation Agent invocation with bounded, parallel calls over collections of at most 10 entities. Add a preceding **Redundant Entity Merging** stage so semantic duplicates are resolved before relations are generated.
...
This design changes entity merging and entity relation generation during uploads of new properties. Entity extraction and property relation generation remain separate workflows. Property removal continues to prune the active snapshot without invoking these stages.
